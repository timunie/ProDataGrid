...
namespace DataGridSample.ViewModels
{
    public class BindableColumnsViewModel : ObservableObject
    {
        ...
        public Array SyncModes => Enum.GetValues<ColumnsSynchronizationMode>();

        public Array ResetBehaviors => Enum.GetValues<ColumnsSourceResetBehavior>();

        public Array AutoPlacements => Enum.GetValues<AutoGeneratedColumnsPlacement>();
